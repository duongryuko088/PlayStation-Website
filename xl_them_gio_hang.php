...
<div class="items-cart-inner">
  <div class="total-price-basket"> <span class="lbl">cart -</span> <span class="total-price"> <span class="value"><?php echo number_format($_SESSION['thanh_tien'],0,',','.')?> Đ</span> </span> </div>
...
<ul class="dropdown-menu">
  ...
  <div class="clearfix cart-total">
    <div class="pull-right"> <span class="text">Total :</span><span class='price'><?php echo number_format($_SESSION['thanh_tien'],0,',','.')?> Đ</span> </div>
    <div class="clearfix"></div>
    <a href="gio_hang.php" class="btn btn-upper btn-primary btn-block m-t-20">Go to cart</a> </div>
</ul>