...
<section class="section featured-product wow fadeInUp">
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					{number_format($sp_new->don_gia*(1-$sp_new->khuyen_mai/100),0,'.',',')} VND				</span>
				...
				<div class="item">
					<div class="blog-post">
						...
						<div class="blog-post-info text-left">
							...
							<a href="bt_{thu_vien::bo_dau($tin->ten_bai_viet)}.{$tin->ma_bai_viet}.html" class="lnk btn btn-primary">Read</a>
						</div><!-- /.blog-post-info -->
