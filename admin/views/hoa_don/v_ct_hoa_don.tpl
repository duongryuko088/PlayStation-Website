						...
						<table>
							...
							<thead>
                            	<tr>
                                    ...
                                    Customer: {$m_hoa_don->xd_kh($smarty.get.ma_hoa_don)->ten_khach_hang}
                                    </td>
                                </tr>
								<tr>
								   <th>Product no</th>
                            	...
                            	<tr>
                                	<td colspan="5">
                                      <div style="width:150px; margin:auto">
                                          ...
                                          type="button" name="btn_xoa" class="btn_xoa_sp" value="Delete"/>
                                          
                                          <input style="height:40px; cursor:pointer" type="submit" class="btn_tt" name="btn_thanh_toan" value="Order"/>
                                       </div>
                                    </td>
                                </tr>
							</tbody>
