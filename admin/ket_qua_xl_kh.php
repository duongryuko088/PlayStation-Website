...
<tr class="">
  ...
  <th> <!-- Icons --> 
    <a href="javascript:Hoi_xoa_nhom('khach_hang','hoa_don','ma_khach_hang',<?php echo $kh->ma_khach_hang?>,'<?php echo $link?>','Customer','Order')" 
    title="Delete"><img src="<?php echo IMG_AD?>/icons/cross.png" alt="Delete" /></a>
    <a href="" title="View more"><img src="<?php echo IMG_AD?>/icons/view-details.png" width="16px"/></a>
   </th>
</tr>
<?php
	}
...
<tr>
  <td colspan="11"><div style="width:150px; margin:auto">
      ...
      onclick="xoa_nhieu_nhom('khach_hang','hoa_don','ma_khach_hang',<?php echo "'".$link."'"?>,'Customer','Order')" value="Delete customer"/>
    </div></td>
</tr>
