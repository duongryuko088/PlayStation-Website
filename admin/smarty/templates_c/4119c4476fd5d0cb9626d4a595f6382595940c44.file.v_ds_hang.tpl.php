<?php /* Smarty version Smarty-3.1.14, created on 2021-12-01 12:32:39
...
','hãng sản xuất','sản phẩm')" style="height:40px; cursor:pointer" type="button" name="btn_xoa_sp" class="btn_xoa_sp" value="Delete"/>
                                        </div>
                                     </td>
                               </tr>
