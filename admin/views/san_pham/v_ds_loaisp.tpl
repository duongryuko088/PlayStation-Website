                                ...
                                <tr>
                                	<td colspan="5">
                                    	<div style="width:150px; margin:auto">
                                        	<input onclick="xoa_nhieu_nhom2('nha_san_xuat','nha_san_xuat','san_pham','ma_nha_san_xuat','ma_loai','{$link}','loại','hãng và sản phẩm')" style="height:40px; cursor:pointer" type="button" name="btn_xoa_sp" class="btn_xoa_sp" value="Delete"/>
                                        </div>
                                     </td>
                               </tr>
