                                ...
                                <tr>
                                	<td colspan="6">
                                    	<div style="width:150px; margin:auto">
                                        	<input onclick="xoa_nhieu_nhom('nha_san_xuat','san_pham','ma_nha_san_xuat','{$link}','hãng sản xuất','sản phẩm')" style="height:40px; cursor:pointer" type="button" name="btn_xoa_sp" class="btn_xoa_sp" value="Delete"/>
                                        </div>
                                     </td>
                               </tr>
