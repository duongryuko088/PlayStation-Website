...
{
?>
<h2 style="text-align:center">Cart be empty</h2>
<?php
	die();
}
		...
		<table class="table table-bordered">
			...
			<tbody>
						...
						<div class="row">
							...
							<div class="col-sm-8">
								<div class="reviews luot_mua">
									(Purchase: <?php echo $san_pham->so_luot_mua?>)
								</div>
							</div>
						</div><!-- /.row -->
				...
				<tr>
                    ...
                    Total: <label style="color:#84b943"><?php echo number_format($_SESSION['thanh_tien'],0,',','.')?> Đ</label>
                    </th>
                </tr>
			</tbody><!-- /tbody -->
		</table><!-- /table -->
...
else
{
	...
	?>
	<h2 style="text-align:center">Your cart be empty</h2>
    <?php
}
?>
