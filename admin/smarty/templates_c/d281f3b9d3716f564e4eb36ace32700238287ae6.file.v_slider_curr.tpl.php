<?php /* Smarty version Smarty-3.1.14, created on 2021-12-17 17:03:45
...
" <?php if ($_smarty_tpl->tpl_vars['i']->value==$_smarty_tpl->tpl_vars['hinh']->value->vi_tri){?>selected<?php }?>>
          ...
          <?php }else{ ?>
            <label>Reject: <input class="id_hinh" type="checkbox" value="<?php echo $_smarty_tpl->tpl_vars['hinh']->value->id;?>
" name="id_hinh[]"/></label>
          <?php }?>
         </div>
    </div>
    ...
    <div class="clear"></div>
    <?php if ($_smarty_tpl->tpl_vars['v']->value!=1){?>
    	<div style="text-align:center"><input id="btn_slider" type="submit" name="btn_slider" value="Update"/></div>
        <script>
