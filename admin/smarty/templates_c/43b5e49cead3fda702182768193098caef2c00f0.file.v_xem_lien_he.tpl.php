<?php /* Smarty version Smarty-3.1.14, created on 2021-12-01 12:02:54
...
<div class="content-box"><!-- Start Content Box -->
                ...
                <?php }?>
					...
					<div class="tab-content default-tab" id="tab1">
                        ...
                        <div style="padding:10px 0">
                          <div style="width:10%; float:left">Content:</div>
                        ...
                        <div style="padding:10px 0">
                          <div style="width:10%; float:left">Reply:</div>
                          <div style="width:90%; float:left">
                             ...
                             <?php if (!empty($_smarty_tpl->tpl_vars['m_common']->value->select_single_id('nguoi_dung','ma_nguoi_dung',$_smarty_tpl->tpl_vars['xem_lien_he']->value->ma_nguoi_dung))){?>
                             	Replying: <?php echo $_smarty_tpl->tpl_vars['m_common']->value->select_single_id('nguoi_dung','ma_nguoi_dung',$_smarty_tpl->tpl_vars['xem_lien_he']->value->ma_nguoi_dung)->ten_dang_nhap;?>
                        ...
                        <div style="padding:10px 0">
                          ...
                          <div style="width:90%; float:left">
                              ...
                              <p style="color:#F00; font-style:italic">Please enter your reply message</p>
                              <?php }?>
                          </div>
                          <div style="clear:both"></div>
                        </div>
...
" class="email_lh"/>
                            <input style="height:40px; cursor:pointer" type="button" name="btn_xoa_lien_he" class="btn_xoa_lien_he" value="Delete" onclick="Hoi_xoa('lien_he','ma_lien_he',<?php echo $_smarty_tpl->tpl_vars['ma_lien_he']->value;?>
,'lien_he.php','liên hệ')"/>
                         <?php if ($_smarty_tpl->tpl_vars['xem_lien_he']->value->trang_thai!=2){?>   
                            <input type="submit" style="height:40px; cursor:pointer; margin-left:10px" name="btn_tra_loi" class="btn_tra_loi" value="Reply"/>
                          <?php }?>
                         </div>
                    </div> <!-- End #tab1 -->      
					</form>
