<?php /* Smarty version Smarty-3.1.14, created on 2021-12-01 12:45:58
...
','thẻ tag')"
                          type="button" name="btn_xoa_sp" class="btn_xoa_sp" value="Delete tag"/>
                       </div>
                    </td>
                </tr>
                <tr>
			...
			<?php }?>
            <div>
            	<h3 style="padding:10px 0">Add tag</h3>
                <form name="frm_them_tag" method="post" action="">
                	tag name: <input name="tag_name" value="<?php echo $_smarty_tpl->tpl_vars['m_common']->value->show_value('','tag_name','');?>
" type="text" required="required"/>
                    <input type="submit" name="btn_them_tag" value="Add tag"/>
