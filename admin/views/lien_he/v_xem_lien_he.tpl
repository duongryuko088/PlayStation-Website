                ...
                {/if}
					...
					<div class="tab-content default-tab" id="tab1">
                        ...
                        <div style="padding:10px 0">
                          ...
                          <div style="width:90%; float:left">
                             ...
                             {if !empty($m_common->select_single_id('nguoi_dung','ma_nguoi_dung',$xem_lien_he->ma_nguoi_dung))}
                             	Replying: {$m_common->select_single_id('nguoi_dung','ma_nguoi_dung',$xem_lien_he->ma_nguoi_dung)->ten_dang_nhap}
                             {else}
                             Replying: user
                             {/if}
                             </p>
                        ...
                        <div style="width:320px; margin:auto">
                            ...
                            <input style="height:40px; cursor:pointer" type="button" name="btn_xoa_lien_he" class="btn_xoa_lien_he" value="Delete" onclick="Hoi_xoa('lien_he','ma_lien_he',{$ma_lien_he},'lien_he.php','Contact')"/>
                         {if $xem_lien_he->trang_thai !=2}   
