...
<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<!-- Logo (221px wide) -->
			<a href="quantri.php"><img id="logo" src="images/logo11.png" alt="logo" style="width:200px" /></a>
		  
			<!-- Sidebar Profile links -->
			<div id="profile-links">
				Hello, <a href="#" title="">admin</a><br />
				<br />
			...
			<ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li>
					...
					<ul>
						<li><a href="tin_tuc.php">Post list</a></li>
						<li><a href="cap_nhat_tin_tuc.php">Add new post</a></li>
					</ul>
				</li>
				...
				<li>
					<a href="hoa_don.php" class="nav-top-link">
						Order <span id="hoa_don_moi">(0)</span>
					</a>
				</li>   
                ...
                <li>
					<a href="lien_he.php" class="nav-top-link">
						Contact <span id="lien-he-moi">(0)</span>
					</a>
				</li>    
...
<div id="footer"> <small> <!-- Remove this notice or replace it with whatever you want --> 
  &#169; Copyright 2009 Your Company | Powered by <a href="">Ultimate Store</a> | <a href="#">Top</a> </small> </div>
<!-- End #footer -->
