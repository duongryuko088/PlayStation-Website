...
<tr class="<?php echo $m_hoa_don->trang_trai_hd($hd->ma_hoa_don,1)?>">
  ...
  <td><!-- Icons --> 
    <a href="javascript:Hoi_xoa_nhom2('khach_hang','hoa_don','chi_tiet_hoa_don','ma_khach_hang',<?php echo $hd->ma_khach_hang?>,'ma_hoa_don',<?php echo $hd->ma_hoa_don?>,'<?php echo $link?>','hóa đơn','khách hàng')" title="Delete"><img src="images/icons/cross.png" alt="Delete" /></a> <a href="ct_hoa_don.php?so_hoa_don=18" title="View more"><img src="images/icons/view-details.png" width="16px"/></a></td>
</tr>
<?php
	}
}
