...
px"></div>
                                            ...
                                            <div class="col-sm-8">
                                                <div class="reviews">
                                                    <a href="#" class="lnk">(Purchases: <?php echo $_smarty_tpl->tpl_vars['san_pham']->value->so_luot_mua;?>
)</a>
                                                </div>
                                            </div>
                                        </div><!-- /.row -->		
                                    ...
                                    Discount 2 million OR Installment 0% until the end of 2021. Chance to win many attractive prizes worth more than 50 million.</div><!-- /.description-container -->
...
"></div>
                                        ...
                                        <p>Please <a href="login_register.php" class="lnk">login </a> to rate the product</p>
                                        <?php }?>
                                    </div>
                                </div><!-- end area_rating -->
...
.html" data-layout="standard" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
			...
			<div class="product-tabs outer-top-smal  wow fadeInUp">
						...
						<ul id="product-tabs" class="nav nav-tabs nav-tab-cell-detail">
							<li class="active"><a data-toggle="tab" href="#description">PRODUCT INFORMATION</a></li>
							<li><a data-toggle="tab" href="#review">PRODUCT INTRODUCTION</a></li>
...
px"></div>
 ...
 Đ</span>
        ...
        <div class="action">
            <label class="container-nut-cart"><a href="javascript:void(0)" class="lnk btn btn-primary">Buy</a></label>
      ...
      <div class="content-lightbox">
          <div class="in-content-lightbox">
              ...
              <div class="danh-gia-san-pham" style="margin:auto; height:100px">
                ...
                <h3>You want to rate this product ?</h3>
