<?php /* Smarty version Smarty-3.1.14, created on 2021-12-01 13:03:22
...
<!-- Start Content Box -->
    <div class="content-box-header">
      ...
      <div style="width:200px; float:left; padding:10px 0">
        <input name="thanh_tim" type="text" id="thanh_tim" placeholder="Enter product name"/>
    ...
    <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
            ...
            <?php if (count($_smarty_tpl->tpl_vars['ds_loai_sp']->value)>0){?>
              <label style="font-weight:bold; font-size:16px">Type of product:</label> 
              <select class="ds_loai" id="ma_loai">
              <option class="loai_sp" value="">All</option>
...
/icons/pencil.png" alt="Edit" /></a>
                    <a href="" title="View more"><img src="<?php echo @constant('IMG_AD');?>
...
','sản phẩm')"
                          type="button" name="btn_xoa_sp" class="btn_xoa_sp" value="Delete product"/>
                        </div>
                    </td>
                </tr>
                <tr>
