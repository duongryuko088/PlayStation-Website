<?php /* Smarty version Smarty-3.1.14, created on 2021-12-07 15:51:32
                                ...
                                <tr>
                                	<td colspan="10">
                                    	<div style="width:150px; margin:auto">
                                        	<input style="height:40px; cursor:pointer" type="button" name="btn_xoa_user" class="btn_xoa_user" value="Delete user" onclick="xoa_nhieu('nguoi_dung','ma_nguoi_dung','<?php echo $_smarty_tpl->tpl_vars['link']->value;?>
','người dùng')"/>
                                        </div>
                                     </td>
                               </tr>
