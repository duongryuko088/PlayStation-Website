...
<!-- Start Content Box -->
    <div class="content-box-header">
      ...
      <div style="width:200px; float:left; padding:10px 0">
        <input name="thanh_tim" type="text" id="thanh_tim" placeholder="Enter order code"/>
    ...
    <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
            ...
            <table id="bang">
              ...
              {foreach $hoa_dons as $hd}
                <tr class="{$m_hoa_don->trang_trai_hd($hd->ma_hoa_don,1)}">
                  ...
                  <td><!-- Icons --> 
                    <a href="javascript:Hoi_xoa_nhom2('khach_hang','hoa_don','chi_tiet_hoa_don','ma_khach_hang',{$hd->ma_khach_hang},'ma_hoa_don',{$hd->ma_hoa_don},'{$link}','hóa đơn','khách hàng')" title="Delete"><img src="images/icons/cross.png" alt="Delete" /></a> <a href="ct_hoa_don.php?ma_hoa_don={$hd->ma_hoa_don}" title="View more"><img src="images/icons/view-details.png" width="16px"/></a></td>
                </tr>
                {/foreach}
                <tr>
                  <td colspan="6"><div style="width:150px; margin:auto">
                      <input style="height:40px; cursor:pointer" onclick="xoa_nhieu_nhom2('khach_hang','hoa_don','chi_tiet_hoa_don','ma_khach_hang','ma_hoa_don','{$link}','hóa đơn','khách_hang')"
                          type="button" name="btn_xoa_sp" class="btn_xoa_sp" value="Delete order"/>
                    </div></td>
                </tr>
                <tr>
            ...
            {include file='views/xl_ajax/v_script_tim.tpl'}
				{else}
				<h3 style="padding:20px 0">No order was found</h3>
				{/if}
         </div> <!-- End #tab1 -->
