...
?>
  <tr class="">
    ...
    <th> <!-- Icons --> 
      <a href="javascript:Hoi_xoa('bai_viet','ma_bai_viet',<?php echo $bv->ma_bai_viet?>,'<?php echo $link?>','Post')" 
                    title="Delete"><img src="<?php echo IMG_AD?>/icons/cross.png" alt="Delete" /></a> <a href="cap_nhat_bai_viet.php?ma_bai_viet=<?php echo $bv->ma_bai_viet?>" title="Edit"><img src="<?php echo IMG_AD?>/icons/pencil.png" alt="Edit" /></a> <a href="../bt_<?php echo thu_vien::bo_dau($bv->ten_bai_viet)?>.<?php echo $bv->ma_bai_viet?>.html" title="View more"><img src="<?php echo IMG_AD?>/icons/view-details.png" width="16px"/></a> </th>
  </tr>
  <?php
	}
}
?>
  ...
  <tr>
    <td colspan="10"><div style="width:150px; margin:auto">
      ...
      onclick="xoa_nhieu('bai_viet','ma_bai_viet',<?php echo "'".$link."'"?>,'Post')" value="Delete"/>
      </div></td>
  </tr>
</tbody>
