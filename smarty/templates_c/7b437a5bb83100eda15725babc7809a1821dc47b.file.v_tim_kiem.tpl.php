<?php /* Smarty version Smarty-3.1.18, created on 2021-12-10 11:43:47
         compiled from "views\tim_kiem\v_tim_kiem.tpl" */ ?>
<?php /*%%SmartyHeaderCode:164372867461b32f63bb7173-26035277%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '164372867461b32f63bb7173-26035277',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_61b32f63bcd708_36604043',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_61b32f63bcd708_36604043')) {function content_61b32f63bcd708_36604043($_smarty_tpl) {?><div class="row">
	<!-- ============================================== SIDEBAR ============================================== -->	
     ...
     <?php if (count($_smarty_tpl->tpl_vars['san_phams']->value)>0) {?>
     	<div class="clearfix filters-container m-t-10">
			<div class="row">
            	<div class='col-md-12'>
                	<h3>Found <label style="color:#900"><?php echo $_smarty_tpl->tpl_vars['tong_so']->value;?>
</label> results for keyword <label style="color:#84b943">'<?php echo $_smarty_tpl->tpl_vars['keyword']->value;?>
'</label></h3>
                </div>
            </div><!-- /.row -->
		</div>
...
px"></div>
	...
	<div class="tag new"><span>new</span></div>        </div><!-- /.product-list -->
      ...
      <?php } else { ?>
      <h3>No results found for keyword '<?php echo $_smarty_tpl->tpl_vars['keyword']->value;?>
'</h3>
      <?php }?>
	</div><!-- /.col -->
        <!-- ============================================== CONTENT : END============================================== -->
