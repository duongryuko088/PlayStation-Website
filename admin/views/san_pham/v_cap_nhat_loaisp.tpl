...
<table>
    ...
    <tr>
        ...
        <td>
            ...
            <input onclick="xoa_hinh('nha_san_xuat','logo','ma_nha_san_xuat',{$ma_loai},'hinh_dang_cn.jpg','{$link}')" type="button" class="xoa_logo" value="Delete logo"/>{/if}
        </td>
    </tr>
    {/if}
    
    <tr>
    	<td colspan="2"><input type="submit" name="btn_cap_nhat_loai_sp" value="Submit"/></td>
    </tr>
</table>
</form>