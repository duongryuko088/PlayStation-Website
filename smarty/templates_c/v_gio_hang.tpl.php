				...
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn" style="text-align:center">
							<span class="">
								<a href="#" id="xoa_gio_hang" class="btn btn-upper btn-primary outer-left-xs">Clear cart</a>
								<a href="#" id="cap_nhat_gio_hang" class="btn btn-upper btn-primary outer-right-xs">Cart update</a>
...
px"></div>
							...
							<div class="col-sm-8">
								<div class="reviews luot_mua">
									(Purchases: <?php echo $_smarty_tpl->tpl_vars['san_pham']->value->so_luot_mua;?>
)
								</div>
							</div>
						</div><!-- /.row -->
...
"/>
				...
				<tr>
                    ...
                    Total price: <label style="color:#84b943"><?php echo number_format($_SESSION['thanh_tien'],0,',','.');?>
 Đ</label>
                    </th>
                </tr>
			</tbody><!-- /tbody -->
