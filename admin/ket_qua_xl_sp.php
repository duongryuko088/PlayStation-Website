...
<tr class="">
  ...
  <th><?php if ($sp->khuyen_mai >0) echo '-'.$sp->khuyen_mai.'%'; else echo 'No';?></th>
  ...
  <th> <!-- Icons --> 
    <a href="javascript:Hoi_xoa('san_pham','ma_san_pham',<?php echo $sp->ma_san_pham?>,<?php echo "'".$link."'"?>,'Product')" 
    ...
    <a href="" title="View more"><img src="<?php echo IMG_AD?>/icons/view-details.png" width="16px"/></a> </th>
</tr>
<?php
	}
}
...
<tr>
  <td colspan="11"><div style="width:150px; margin:auto">
      ...
      onclick="xoa_nhieu('san_pham','ma_san_pham',<?php echo "'".$link."'"?>,'Product')" value="Delete product"/>
    </div></td>
</tr>
