...
<div class="track-order-page inner-bottom-sm">
	...
	<form method="post" class="register-form outer-top-xs" role="form" name="frm_dat_hang">
		<div class="form-group">
		    <label class="info-title" for="exampleOrderId1">Fullname</label>
        ...
        <div class="form-group">
		    <label class="info-title" for="exampleOrderId1">Phone Number</label>
            ...
            <p style="font-style:italic; color:#F00">Please enter a valid phone number</p>
            <?php }?>
		</div>
...
<?php } else { ?>
	...
	<h3>Thank you for purchasing our products</h3>
	<?php } else { ?>
