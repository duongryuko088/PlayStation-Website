...
<?php echo $_smarty_tpl->tpl_vars['m_nguoi_dung']->value->remove_session_login_false();?>
	...
	<form method="post" name="frm_login" class="register-form outer-top-xs" role="form">
		...
		<div class="radio outer-xs">
		  	...
		  	<a href="forget_pass.php" class="forgot-password pull-right">Forget your Password ?</a>
		</div>
	  	<button name="btn_dn" type="submit" class="btn-upper btn btn-primary checkout-page-button">Sign in</button>
	</form>					
</div>
<!-- Sign-in -->
...
<div class="col-md-6 col-sm-6 create-new-account">
	...
	<p class="text title-tag-line">Create an account</p>
