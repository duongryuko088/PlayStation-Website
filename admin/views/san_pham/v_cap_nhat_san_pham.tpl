					...
					<div class="tab-content default-tab" id="tab1"> 
                    	<form class="form-sua-bai" name="form_sua_sp" action="" method="post" enctype="multipart/form-data">
                            <div class="container-form">
                              ...
                              <input onclick="xoa_hinh('san_pham','hinh','ma_san_pham',{$smarty.get.ma_san_pham},'hinh_dang_cn.jpg','{$link}')" type="button" class="xoa_hinh" value="Delete image"/>
                              {/if}
                                {/if}
                              ...
                              {foreach $hinh_chi_tiet as $hinhct}
                              	<div class="cont-img">
                                    ...
                                    <label><input class="xoa_hinh" type="checkbox" value="{$hinhct->khoa_chinh}"/>Delete</label>
                                </div>
                                {/foreach}
                                <div class="clear"></div>
                              ...
                              <div style="font-size:18px; margin:10px auto">
                              	<label>Promotion: <input type="number" name="km" value="{if isset($smarty.post.btn_them_sp)}{$smarty.post.km}{else if isset($smarty.get.ma_san_pham)}{$san_pham->khuyen_mai}{else}0{/if}"/></label>
                                <label>Quantity: <input type="number" name="so_luong" value="{if isset($smarty.post.btn_them_sp)}{$smarty.post.so_luong}{else if isset($smarty.get.ma_san_pham)}{$san_pham->so_luong}{else}0{/if}"/></label>
                              </div>
