...
class M_lien_he extends database{
	...
	public function tra_loi_lh($mail_nguoi_nhan,$ten_nguoi_nhan){
		if(isset($_POST['btn_tra_loi']))
		{
			...
			$noidung ="<br>Hello, please leave a message: " .''.$ten_nguoi_nhan;
			$noidung .="<br><br>" .$_POST["tra_loi_lh"];
			$mail->SetFrom('saohoa1007@gmail.com','Ultimate Store');
			$mail->Subject='Ultimate Store has replied';
			...
			if(strlen(trim($_POST["tra_loi_lh"])) > 0)
			{
				...
				setcookie('tra_loi_xong','Message has been replied',time() +60*20);
