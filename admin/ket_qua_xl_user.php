...
<tr>
  ...
  <td><img src="<?php echo IMG_AD.'/icons/'.$user->gioi_tinh?>.png" width="25"/></td>
  <td><!-- Icons --> 
    <a href="javascript:Hoi_xoa('nguoi_dung','ma_nguoi_dung',<?php echo $user->ma_nguoi_dung?>,'<?php echo $link?>','User')" title="Delete"><img src="images/icons/cross.png" alt="Delete" /></a></td>
</tr>
...
$('.ten_loai').each(function(index) {
    ...
    $('.ten_loai').eq(index).change(function(){
	  ...
	  if(confirm('Do you want to change type of user?'))
...
<tr>
  <td colspan="10"><div style="width:150px; margin:auto">
      <input style="height:40px; cursor:pointer" type="button" name="btn_xoa_user" class="btn_xoa_user" value="Delete user" onclick="xoa_nhieu('nguoi_dung','ma_nguoi_dung','<?php echo $link?>','user')"/>
    </div></td>
</tr>
</tbody>
