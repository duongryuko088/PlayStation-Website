...
<!-- Start Content Box -->
    <div class="content-box-header">
      ...
      <div style="width:200px; float:left; padding:10px 0">
        <input name="thanh_tim" type="text" id="thanh_tim" placeholder="Enter post name"/>
    ...
    <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
            ...
            {if count($ds_loai_bai) > 0}
              <label style="font-weight:bold; font-size:16px">Post type:</label> 
              <select class="ds_loai" id="ma_loai_bai">
              <option class="loai_bai" value="">All</option>
              ...
              {foreach $bai_viets as $bv}
                <tr class="">
                  ...
                  <th> <!-- Icons --> 
                    ...
                    <a href="../bt_{thu_vien::bo_dau($bv->ten_bai_viet)}.{$bv->ma_bai_viet}.html" title="View more"><img src="{$smarty.const.IMG_AD}/icons/view-details.png" width="16px"/></a>
                    </th>
                </tr>
                {/foreach}
                <tr>
                  <td colspan="10">
                      <div style="width:150px; margin:auto">
                          ...
                          type="button" name="btn_xoa_sp" class="btn_xoa_sp" value="Delete post"/>
                        </div>
                    </td>
                </tr>
                <tr>
            ...
            {include file="views/xl_ajax/v_script_tim_2.tpl"}
				...
				{else}
				<h3 style="padding:20px 0">No post was found</h3>
				{/if}     
         </div> <!-- End #tab1 -->
