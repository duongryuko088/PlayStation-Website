            ...
            <table id="bang">
              ...
              {foreach $ds_lien_he as $lh}
                <tr class="{$m_lien_he->trang_trai_lh($lh->ma_lien_he,1)}">
                  ...
                  <td><!-- Icons --> 
                    <a href="javascript:Hoi_xoa('lien_he','ma_lien_he',{$lh->ma_lien_he},'{$link}','Contact')" title="Delete"><img src="images/icons/cross.png" alt="Delete" /></a> <a href="xem_lien_he.php?ma_lien_he={$lh->ma_lien_he}" title="View more"><img src="images/icons/view-details.png" width="16px"/></a></td>
                </tr>
                {/foreach}
                <tr>
                  <td colspan="9"><div style="width:150px; margin:auto">
                      <input style="height:40px; cursor:pointer" onclick="xoa_nhieu('lien_he','ma_lien_he','{$link}','Contact')"
                          type="button" name="btn_xoa_sp" class="btn_xoa_sp" value="Delete"/>
                    </div></td>
                </tr>
                <tr>
              ...
              {include file="views/xl_ajax/v_script_phan_tu.tpl"}
				...
				{else}
				<h3 style="padding:20px 0">No result was found</h3>
				{/if}
         </div> <!-- End #tab1 -->
