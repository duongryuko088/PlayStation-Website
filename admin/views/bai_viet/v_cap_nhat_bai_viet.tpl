                    	...
                    	<form class="form-sua-bai" name="form_sua_bai" action="" method="post" enctype="multipart/form-data">
                            <div class="container-form">
                              ...
                              <div class="bao_loi_php">
                                <div class="thanh-loi">Add title</div>
                                <div class="clear"></div>
                              </div>
                              {/if}
                              
                              <div class="dong-input">
                                <div class="ten-input">Type of post:</div>
                              ...
                              <div style="margin-top:50px; margin-bottom:20px">
                                  <label style="font-size:18px">Upload main image of post : </label>
                              ...
                              <input onclick="xoa_hinh('bai_viet','hinh','ma_bai_viet',{$ma_bai_viet},'hinh_dang_cn.jpg','{$link}')" type="button" class="xoa_hinh" value="Delete image"/>
                                {/if}
                                {/if}
                                
                               <div class="dong-input">
                                <div class="ten-input">Summary content:</div>
                                <div class="clear"></div>
                              ...
                              <div class="bao_loi_php">
                                <div class="thanh-loi">Add summary content</div>
                                <div class="clear"></div>
                              </div>
                              {/if}
                              
                                 <div class="dong-input">
                                <div class="ten-input">Detailed content:</div>
                                <div class="clear"></div>
                                <div style="width:100%; float:none; margin:15px auto" class="thanh-input">
                              ...
                              <div class="bao_loi_php">
                                <div class="thanh-loi">Add detailed content</div>
                                <div class="clear"></div>
                              </div>
                              {/if}
                              ...
                              <div class="dong-input">
                                <div style="width:100px; margin:auto">
                                  <input name="btn_them_bv" type="submit" class="nut-submit" value="Save"/>
                                </div>
                              </div>
                            </div>
                          </form>
