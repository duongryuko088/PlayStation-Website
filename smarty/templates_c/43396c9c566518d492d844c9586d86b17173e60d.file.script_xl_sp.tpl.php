...
<?php /*%%SmartyHeaderCode:164139206961af776f3fe546-69656537%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '164139206961af776f3fe546-69656537',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_61af776f41e488_01120373',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_61af776f41e488_01120373')) {function content_61af776f41e488_01120373($_smarty_tpl) {?><script>
  ...
  $('.container-nut-cart-ajax').each(function(index) {
		...
		$('.container-nut-cart-ajax').eq(index).click(function(e){
			...
			if($('.sl_dat_mua-ajax').eq(index).val()>0)
			{
				...
				var thong_bao_them_hang = 'You have added to cart:<br/><label style="color:#09F; font-weight:bold; font-size:18px">'+$ten_san_pham+'</label><br/> Quantity: <label style="color:#F00; font-weight:bold">'+$so_luong+'</label> .';
